package com.autowave.base.exception;
...
public abstract class ApiResponseExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(com.autowave.base.exception.DataException.class)
    ...
    @ExceptionHandler(com.autowave.base.exception.BusinessException.class)
